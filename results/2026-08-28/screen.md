...
- 市场数据日期：`2026-08-28`
- 生成时间（UTC）：`2026-08-29T05:33:06.142045+00:00`
- 股票池：5,322
- 具备完整 7+7 区间数据：4,911
- 规则匹配总数：0
- 本报告保留：0
...
|---:|---|---:|---:|---:|
| 1 | 最新价在 $50–$200 | 981 | 3,930 | 20.0% |
| 2 | 7 日累计跌幅 18%–45% | 2 | 979 | 0.2% |
| 3 | 平台总振幅 ≤ 7% | 0 | 2 | 0.0% |
| 4 | 平台趋势绝对值 ≤ 3.5% | 0 | 0 | — |
| 5 | 平台日收益波动率 ≤ 2.2% | 0 | 0 | — |
| 6 | 平台单日绝对涨跌 ≤ 3.5% | 0 | 0 | — |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| 价格池的 7 日涨跌幅 | 981 | -5.06 | -2.25 | 0.10 | 2.94 | 6.29 | -45% 至 -18% |
| 跌幅池的平台振幅 | 2 | 9.55 | 11.55 | 14.87 | 18.20 | 20.19 | ≤ 7% |
| 跌幅池的平台趋势绝对值 | 2 | 5.78 | 6.97 | 8.96 | 10.96 | 12.15 | ≤ 3.5% |
| 跌幅池的平台日收益波动率 | 2 | 2.56 | 2.99 | 3.71 | 4.43 | 4.86 | ≤ 2.2% |
| 跌幅池的平台单日最大涨跌 | 2 | 6.08 | 7.12 | 8.87 | 10.62 | 11.66 | ≤ 3.5% |
| 跌幅池的平台平均成交额（$M） | 2 | 48.88 | 120.37 | 239.51 | 358.66 | 430.15 | ≥ 20 |
...
|---|---:|---:|---:|---:|---:|---:|---|
| **NYAX** | -22.37% | 21.52% | 12.95% | 5.15% | 12.36% | $1.22M | 振幅、趋势、波动率、单日涨跌、成交额 |
| **TPR** | -20.06% | 8.22% | 4.98% | 2.27% | 5.38% | $477.81M | 振幅、趋势、波动率、单日涨跌 |
...
| 仅把单日涨跌放宽至 5% | 0 | +0 | — |
| 仅把成交额降至 $10M | 0 | +0 | — |
| 平衡召回（15/9/5/3/5/$10M） | 1 | +1 | KALU |
| 宽松研究池（12/12/7/4/7/$5M） | 4 | +4 | MIDD, KALU, VIK, TPR |
